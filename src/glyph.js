...
export default class Glyph {
    ...
    initializeProperties(char, args) {
        ...
        this.unitsPerEm = args.unitsPerEm || 1024;
        this.lineHeightRatio = typeof args.lineHeight === 'number' ? args.lineHeight : .75;
        this.lineHeight = this.fontSize * this.lineHeightRatio;
        this.scale = this.fontSize / this.unitsPerEm;
        const widthUnits = typeof args.width === 'number' ? args.width : 0;
        const heightUnits = typeof args.height === 'number' ? args.height : 0;
        this.width = Math.round(widthUnits * this.scale);
        this.height = Math.round(heightUnits * this.scale);
